...
public class GoibiboDemo {
	...
	public static void main(String[] args) {
		 WebDriver driver = new FirefoxDriver();
	        ...
	        WebElement auto_suggest=(new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.className("autoSuggestList")));
	        ...
	        //It will return all element with li tag
