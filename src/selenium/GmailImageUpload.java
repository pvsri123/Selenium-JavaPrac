...
public class GmailImageUpload {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		// to pasuse the execution until the  pwd edit box is available
		...
		Thread.sleep(2000);
		driver.findElement(By.name("subjectbox")).sendKeys("Your Photo");
		Thread.sleep(2000);
	 ...
	 //   upload.click();
		...
		// ctl+C -to copy the value into the system clipboard
	    StringSelection filepath = new StringSelection("C:\\Users\\Sreenivas\\Pictures\\Passport-PhotoSreenivas.jpg");
